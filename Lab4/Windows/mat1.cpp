...
int main() {
    int n = 1000, m = 1000, nnz = 100000; // Example sizes

    matCsr csr;
    mat dense, result1, result2;

    generateRandomSparseMatrix(csr, n, m, nnz);
    generateRandomMatrix(dense, m, n);
