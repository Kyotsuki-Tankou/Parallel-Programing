...
// //nvcc -o kernel.exe -ccbin "C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Tools\MSVC\14.33.31629\bin\Hostx64\x64\cl.exe" kernel.cu -Xcompiler -fopenmp
// #include <vector>
// #include <random>
// #include <iostream>
// #include <chrono>
...
//     // matCsr csr;
//     // mat B(m, n), C;
//     for(int s=1024;s>=4;s>>=1)
//     {
//         matCsr csr;
//         mat B(n, n), C;
//         // generateRandomSparseMatrix(csr, n, m, nnz);
//         // generateRandomMatrix(B, m, n);
//         generateRandomSparseMatrix(csr, n, n, 1ll*n*n/s);
//         generateRandomMatrix(B, n, n);
//         for (int thr = 8; thr <= 8; thr++)
//         {
//             auto start = high_resolution_clock::now();
//             for (int i = 1; i < 10; i++)  matMultiply(csr, B, C, splitFactor, thr);
